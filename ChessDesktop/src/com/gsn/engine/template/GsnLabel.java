 ...
 * @author Nathan Sweet */
public class GsnLabel extends Widget {
	...
	public GsnLabel (Skin skin) {
		this("", skin);
	}

	public GsnLabel (String text, Skin skin) {
	 ...
	 * color. */
	public GsnLabel (String text, String fontName, Color color, Skin skin) {
	 ...
	 * skin. */
	public GsnLabel (String text, String fontName, String colorName, Skin skin) {
...
//		if (wrap)
//			return cache.getFont().getWrappedBounds(text, width);
//		else
//			return cache.getFont().getMultiLineBounds(text);
		return bounds;
	}
