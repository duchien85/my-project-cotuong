...
public class LobbyLayer extends GsnLayer implements ClickListener {
	...
	public LobbyLayer(float width, float height) {
		...
		bet1000 = new GsnEnableButton(1, "quick play", CommonTexture.bet100_1, CommonTexture.bet100_2, CommonTexture.bet100_3, CommonTexture.bet100_4);
		bet5000 = new GsnEnableButton(1, "quick play", CommonTexture.bet500_1, CommonTexture.bet500_2, CommonTexture.bet500_3, CommonTexture.bet500_4);		
